...
const Account = () => {
  ...
  return (
    <div className="lg:w-2/3">
      {loggedin === "true" && <><div className="mb-10 ">
        <img
          src={userData.userImg === "" ? DefaultImage : userData.userImg}
          alt="Hellow World"
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-col items-start p-4 gap-2">
          <Link to="/account/dashboard/editprofile" className="text-primary hover:text-black dark:hover:text-white active:text-orange-500">
            Edit Profile
          </Link>
          <Link to="/account/dashboard/new" className="text-primary hover:text-black dark:hover:text-white active:text-orange-500">
            Create New Post
          </Link>
          <Link to="/account/dashboard/posts" className="text-primary hover:text-black dark:hover:text-white active:text-orange-500">
            View My Posts
          </Link>
        </div>
      </div>
