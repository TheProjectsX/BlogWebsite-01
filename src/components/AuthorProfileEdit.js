  ...
  return (
    <div className="flex flex-col items-center lg:w-2/3">
      ...
      >
        ...
        <Link to="/account/dashboard" className="w-2/3 md:w-1/2"><button
          className="w-full border-2 border-black bg-black text-white p-2 text-lg rounded-md font-bold hover:border-primary hover:bg-primary active:bg-white active:text-black active:border-black"
        >
          Back to Dashboard
        </button>
        </Link>
